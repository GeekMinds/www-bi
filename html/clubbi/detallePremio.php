...
$idbeneficio = 1;
if (isset($_REQUEST['premio'])) {
    $idbeneficio = $_REQUEST['premio'];
}
$beneficios = get($wsServer . 'premio/' . $idbeneficio);
if ($beneficios["Result"] == false) {
    exit();
}
$idCategoria=1;
$beneficios = (array) $beneficios["JSON"];
$beneficio = (array) $beneficios["premio"];
$nombreCategoria='';
if(isset($beneficio["empresa"])){
...
<html class="no-js" lang="en">
    <head>
        ...
        <style>
            ...
            .arrow-left-color{
                ...
                border-right: 12px solid #26B4F1 ;
            ...
            .arrow-left-white{
                border-left: 18px solid #26B4F1 ;
                border-right: 12px solid transparent;
                border-top: 18px solid #26B4F1 ;
                border-bottom: 18px solid #26B4F1 ;
                margin: 0px;
                padding: 0px;
            }
            .row.withpadding {
    ...
    <script>(function(d, s, id) {
        ...
        js.id = id;
        js.src = "//connect.facebook.net/es_LA/sdk.js#xfbml=1&appId=297939197024193&version=v2.0";
            ...
            <div class="small-12 medium-12 large-12 columns">
                <div class="row">
                    <div class="small-6 medium-6 large-6 columns nopaddingright">
                        <div  style="background: url('<?= $beneficio["imagen"] ?>');" class="imgcarrousell"></div>
                    </div>
...
<!--                            <img src="media/images/logo_top_margin.jpg"/>
                        ...
                        <div class="left small-6 medium-6 large-6 info columns">
                            ...
                            <div class="small-12 medium-12 large-12 columns categoria">
                                Rating:  <?= $beneficio["puntos"] ?>
                            </div>
                            <div class="small-12 medium-12 large-12 columns caducidad">
                                Vigencia: <?= date("d/m/Y", strtotime($beneficio["fecha_vencimiento"])) ?>
                            </div>
    ...
    <div class="row withpadding">
        <div class="small-12 medium-8 large-5 columns right " onclick="javascript:returnGallery();">
            ...
            <div class="small-10 medium-10 large-10 columns bg">
                Regresar al catalogo de Premios
            </div>
    ...
    <script>
            ...
            function returnGallery() {
                top.location = 'catalogoPremios.php';
            }
            $(function() { 
