...
if (isset($_REQUEST['establecimiento'])) {
    $idbeneficio = $_REQUEST['establecimiento'];
}
$beneficios = get($wsServer . 'establecimiento/' . $idbeneficio);
...
$beneficio = (array) $beneficios["empresas"];
...
//    //var_dump($empresa);
$imgEmpresa;
if(isset($beneficio["logo"])){
    $imgEmpresa = $beneficio["logo"];
}
    ...
    <body>
        ...
        <div class="row">
            <div class="large-12 medium-12 small-12 columns">          
                ...
                <div class="large-12 medium-12 small-12 columns">
                    <div class="infoContent">
                        <p><?= 'No hay Restricciones en el servicio' ?></p>
        ...
        <script>
                ...
                function returnGallery() {
                    top.location = 'establecimientos.php';
                }
                $(function() {
