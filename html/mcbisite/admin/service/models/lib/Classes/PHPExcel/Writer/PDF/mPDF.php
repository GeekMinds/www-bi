...
$pdfRendererClassFile = PHPExcel_Settings::getPdfRendererPath() . '/mPDF/mpdf.php';
if (file_exists($pdfRendererClassFile)) {
    require_once $pdfRendererClassFile;
	
} else {
    throw new PHPExcel_Writer_Exception('Carlos Unable to load PDF Rendering library'.$pdfRendererClassFile);
}
