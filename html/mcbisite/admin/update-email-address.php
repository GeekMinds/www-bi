...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Actualizar Email | <?php echo $websiteName; ?> </title>
    ...
    if (count($errors) > 0) {
        ?>
                ...
                <div class="modal-footer">
                    <input type="submit" class="btn btn-primary" name="new" id="newfeedform" value="Actualizar" />
                </div>
            ...
            <p style="margin-top:30px; text-align:center;"><a href="./">Inicio</a></p>
        </div>
    </body>
</html>
