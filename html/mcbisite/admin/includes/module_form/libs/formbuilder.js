...
(function() {
  ...
  BuilderView = (function(_super) {
    ...
    BuilderView.prototype.initialize = function(options) {
      ...
      var selector;
      selector = options.selector, this.formBuilder = options.formBuilder, this.bootstrapData = options.bootstrapData,this.crm = options.crm;
    ...
    BuilderView.prototype.initAutosave = function() {
      ...
      console.log("ACA BIENE CRM"+this.crm);
...
//      }
      ...
      var hola = $.trim($('#inpt_form_name_es').val());//POR SI LO LLENA DE ESPACIOS EN BLANCO

      if(hola.length>0){
          //SI TIENE NOMBRE EL FORM
            this.formSaved = true;
      ...
      else // SI NO TIENE NOMBRE REGRESO QUE NO TIENE Y NO GUARDO
      {
                this.formSaved = false;
                this.saveFormButton.removeAttr('disabled').text(Formbuilder.options.dict.SAVE_FORM);
                return this.formBuilder.trigger('name', "ERROR");
      }
...
this["Formbuilder"]["templates"]["edit/label_description"] = function(obj) {
 //SE COMENTO ESTO PORQUE TODAVIA NO ESTA DEFINIDO SI USARA DESCRIPCION
...
((__t = ( Formbuilder.options.mappings.LABEL )) == null ? '' : __t) +
'\' />';
__p += '<div class=\'fb-edit-section-header\'>Nombre en Ingles</div>\n<label>\n  <input  type=\'text\' data-rv-input=\'model.' +
((__t = ( Formbuilder.options.mappings.LABEL_EN )) == null ? '' : __t) +
'\' />';
__p += '<label>\n <div class=\'fb-edit-section-header\'>ID de Campo En CRM</div>\n <input  type=\'text\' data-rv-input=\'model.' +
((__t = ( Formbuilder.options.mappings.CRM_FIELD_ID )) == null ? '' : __t) +
'\' />';
...
this["Formbuilder"]["templates"]["edit/min_max"] = function(obj) {
 //ESTO ESTA COMENTADO PORQUE SE DECIDIO NO DAR VALORES MINIMOS NI MAXIMOS HASTA EL MOMENTO   
 /*
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-edit-section-header\'>Restriccion de Longitud</div>\n\nMin\n<input id="min" onblur="valmin()"  type="text" data-rv-input="model.' +
((__t = ( Formbuilder.options.mappings.MINLENGTH )) == null ? '' : __t) +
'" style="width: 30px" />\n\n&nbsp;&nbsp;\n\nMax\n<input id="max" onblur="valmax()" type="text"  data-rv-input="model.' +
((__t = ( Formbuilder.options.mappings.MAXLENGTH )) == null ? '' : __t) +
'" style="width: 30px" /><div class=\'fb-edit-section-header\'>Opciones</div>\n<label>\n  <input type=\'checkbox\' data-rv-checked=\'model.' +
((__t = ( Formbuilder.options.mappings.HIDDEN )) == null ? '' : __t) +
'\' />\n  Oculto\n</label>\n<label>\n\n<br>Get Var\n<input id="getvar"  type="text"  data-rv-input="model.' +
((__t = ( Formbuilder.options.mappings.GETVAR )) == null ? '' : __t) +
'" style="width: 125px" maxlength="10"/> <br>Blanco: Sin Variable '; /*\n\n&nbsp;&nbsp;\n\n<select data-rv-value="model.' +
...
'\'>\n  <input type="checkbox" class=\'js-default-updated\' data-rv-checked="option:checked" />\n  <input type="text" data-rv-input="option:label_en" class=\'option-label-input\' /> <input type="text" data-rv-input="option:label_es" class=\'option-label-input\' />\n  <a class="js-add-option ' +
...
this["Formbuilder"]["templates"]["edit/size"] = function(obj) {
    //SE COMENTO ESTA PARTE PORQUE TODAVIA NO ESTA PENSADO AGREGARLO
    /*
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
'" title="Eliminar campo"><i class=\'fa fa-minus-circle\'></i></a>\n</div>';
