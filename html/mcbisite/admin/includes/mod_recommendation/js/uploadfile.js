(function (b) {
    if (b.fn.ajaxForm == undefined) {
        b.getScript("js/functions/gio.js")
    }
    var a = {};
    ...
    b.fn.uploadFile = function (t) {
        var r = b.extend({
            ...
            deletelStr: "Borrar",
            doneStr: "Ok",
            multiDragErrorStr: "No se permite múltiple de arrastrar y soltar archivos.",
            extErrorStr: " \n no esta permitido, Solo se permiten los siguientes archivos: ",
            sizeErrorStr:" \n no esta permitido, el maximo permitido: ",
            uploadErrorStr: "Subir No se permite",
            maxFileCountErrorStr: " \n no esta permitido. Limite maximo de archivos es:",
        ...
        (function k() {
            if (b.fn.ajaxForm) {
                if (r.dragDrop) {
                    var s = b('<div class="ajax-upload-dragdrop" style="vertical-align:top;"></div>').width(r.dragdropWidth);
                    b(m).before(s);
                    b(s).append(e);
